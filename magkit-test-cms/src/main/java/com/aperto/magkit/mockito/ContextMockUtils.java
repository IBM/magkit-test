...
import com.aperto.magkit.mockito.jcr.QueryManagerStubbingOperation;
...
import static com.aperto.magkit.mockito.WebContextStubbingOperation.stubExistingResponse;
...
public final class ContextMockUtils extends ComponentsMockUtils {
    ...
    public static WebContext mockWebContext(Locale locale) throws RepositoryException {
        return mockWebContext(stubLocale(locale));
    }
    ...
    public static WebContext mockWebContext(WebContextStubbingOperation... stubbings) throws RepositoryException {
        ...
        if (MgnlContext.hasInstance()) {
            ...
            stubExistingResponse().of(context);
    ...
    public static void register(AggregationState aggState) throws RepositoryException {
        mockWebContext(stubAggregationState(aggState));
    }
    ...
    public static QueryManager mockQueryManager(final String workspace, QueryManagerStubbingOperation... stubbings) throws RepositoryException {
        mockWebContext(stubJcrSession(workspace));
