...
import static com.aperto.magkit.mockito.jcr.QueryStubbingOperation.stubbLanguage;
import static com.aperto.magkit.mockito.jcr.QueryStubbingOperation.stubbResult;
import static com.aperto.magkit.mockito.jcr.QueryStubbingOperation.stubbStatement;
...
import static com.aperto.magkit.mockito.jcr.WorkspaceStubbingOperation.stubQueryManager;
...
public final class QueryMockUtils {
    ...
    public static Row mockRow(String selector, String value, double score) throws RepositoryException {
        ...
        if (value != null) {
            doReturn(mockValue(value)).when(result).getValue(selector);
        }
